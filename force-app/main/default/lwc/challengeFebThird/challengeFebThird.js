...
const COLUMNS = [
    ...
    { label: 'Subject', fieldName: SUBJECT_FIELD.fieldApiName, type: 'text', editable: true },
    { label: 'Status', fieldName: STATUS_FIELD.fieldApiName, type: 'text', editable: true },
    { label: 'Priority', fieldName: PRIORITY_FIELD.fieldApiName, type: 'text', editable: true }
];
